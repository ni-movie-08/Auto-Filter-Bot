...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002348742549').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002267296527')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002386346176')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://nimovie09:673e5e5ae8561147ef7d34d1@cluster0.cbk2f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002485630773")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://t.me/+GuArWk32r5w1Mjhl")
if len(URL) == 0:
    print('Error - URL is missing, exiting now')
    exit()
else:
    if URL.startswith(('https://', 'http://t.me/+GuArWk32r5w1Mjhl')):
        if not URL.endswith("/"):
            URL += '/'
